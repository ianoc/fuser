...
use fuser::fuse_sys::fuse_args;
#[cfg(feature = "libfuse2")]
use fuser::fuse_sys::fuse_mount_compat25;
#[cfg(not(feature = "libfuse"))]
use fuser::fuse_sys::{fuse_mount_pure, fuse_unmount_pure};
...
pub fn unmount(mountpoint: &Path, fuse_session: *mut c_void, fd: c_int) -> io::Result<()> {
    ...
    fn libc_umount(mnt: &CStr, fuse_session: *mut c_void, fd: c_int) -> c_int {
        #[cfg(feature = "libfuse2")]
        use fuser::fuse_sys::fuse_unmount_compat22;
